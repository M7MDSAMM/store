<footer class="footer-area with-black-background margin-zero pt-100">
    ...
    <div class="footer-shape-1">
        <img src="{{ asset('website/assets/images/footer/footer-shape-1.png') }}" alt="image">
    </div>
    <div class="footer-shape-2">
        <img src="{{ asset('website/assets/images/footer/footer-shape-2.png') }}" alt="image">
    </div>
    <div class="footer-shape-3">
        <img src="{{ asset('website/assets/images/footer/footer-shape-3.png') }}" alt="image">
    </div>
</footer>
